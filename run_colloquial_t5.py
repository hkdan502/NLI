...
class DataProcessor(object):
    ...
    def _create_examples(self, lines, max_evidences=5):
        ...
        for i, datapoint in enumerate(tqdm(lines)):
            ...
            datapoint['question'] = datapoint['fever_claim']#datapoint['question']빈것 대체시도
...
if __name__ == "__main__":
    ...
    data_dir = os.path.abspath(os.path.join(os.getcwd(), 'colloquial-claims/data'))#/colloquial_claims_train_t5.jsonl'))
    parser.add_argument("--data_dir", help="path to data", default=data_dir)
    ...
    parser.add_argument("--num_train_epochs", default=1) #more quicker

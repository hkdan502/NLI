    ...
    def _create_examples(self, lines, max_evidences=3):
        ...
        for i, datapoint in enumerate(tqdm(lines)):
            ...
            if 'dpr_evidence' in datapoint.keys():
                ...
                #datapoint['evidence_touse']가 없다는 오류를 받고, 위 세 줄을 살리고 아래 네 줄을 죽임. 17Apr2023
                '''
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", help="path to data", default='./faviq/dpr/faviq_r_set')
    '''
    ...
    parser.add_argument("--num_train_epochs", default=1) #for testing
